    ...
    $pro_id=$row_cart['p_id'];
      $size=$row_cart['size'];
       ...
       while($row_pro=mysqli_fetch_array($run_pro)){
           ...
           $insert_customer_order="insert into customer_order (customer_id,product_id,due_amount,invoice_no,qty,size,order_date,order_status) values('$customer_id','$pro_id','$subtotal','$invoice_no','$qty','$size',NOW(),'$status')";
